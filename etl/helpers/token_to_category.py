TOKEN_TO_CATEGORY = {
    ...
    'university department': ('university', 'university'),
    'language school': ('specialized_school', 'specialized_school'),
    'music school': ('specialized_school', 'specialized_school'),
    'driving school': ('driving_school', 'specialized_school'),
    'trade school': ('specialized_school', 'specialized_school'),
    'prep school': ('specialized_school', 'specialized_school'),
    'ski school': ('specialized_school', 'specialized_school'),
    'surf school': ('specialized_school', 'specialized_school'),
    'sailing school': ('specialized_school', 'specialized_school'),
    'flight school': ('specialized_school', 'specialized_school'),
    'maritime school': ('specialized_school', 'specialized_school'),
    'cooking school': ('specialized_school', 'specialized_school'),
    'dancing school': ('specialized_school', 'specialized_school'),
    'pilot school': ('specialized_school', 'specialized_school'),
